...
cnn11 = np.load('C:/Users/aksha/Documents/Jupyter Notebooks/radioml-classification/Notebooks/Data/CNN-11/accResSNR.npy')
cnn13 = np.load('C:/Users/aksha/Documents/Jupyter Notebooks/radioml-classification/Notebooks/Data/CNN-13/accResSNR.npy')
cnn14 = np.load('C:/Users/aksha/Documents/Jupyter Notebooks/radioml-classification/Notebooks/Data/CNN-14/accResSNR.npy')
cnn15 = np.load('C:/Users/aksha/Documents/Jupyter Notebooks/radioml-classification/Notebooks/Data/CNN-15/accResSNR.npy')
...
#plt.plot(np.arange(-20,20,2), cnn11.T, label='CNN-11')
#plt.plot(np.arange(-20,20,2), cnn13.T, label='CNN-13')
plt.plot(np.arange(-20,20,2), cnn14.T, label='CNN-14')
plt.plot(np.arange(-20,20,2), cnn15.T, label='CNN-15')
...
ann7 = np.load('C:/Users/aksha/Documents/Jupyter Notebooks/radioml-classification/Notebooks/Data/ANN-7/accResSNR.npy')
ann8 = np.load('C:/Users/aksha/Documents/Jupyter Notebooks/radioml-classification/Notebooks/Data/ANN-8/accResSNR.npy')
ann9 = np.load('C:/Users/aksha/Documents/Jupyter Notebooks/radioml-classification/Notebooks/Data/ANN-9/accResSNR.npy')
...
plt.plot(np.arange(-20,20,2), ann7.T, label='ANN-7')
plt.plot(np.arange(-20,20,2), ann8.T, label='ANN-8')
plt.plot(np.arange(-20,20,2), ann9.T, label='ANN-9')
#plt.plot(np.arange(-20,20,2), cnn7.T, label='CNN-7')
#plt.plot(np.arange(-20,20,2), cnn8.T, label='CNN-8')
#plt.plot(np.arange(-20,20,2), cnn9.T, label='CNN-9')
#plt.plot(np.arange(-20,20,2), cnn10.T, label='CNN-10')
